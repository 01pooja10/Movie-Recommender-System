...
if option=='Welcome':
    ...
    st.subheader('Welcome to my movie recommendation system which uses 2 different approaches to recommend movies similar to that entered by the user.')
    st.image('images/img1.jpg',width=600,height=600)
